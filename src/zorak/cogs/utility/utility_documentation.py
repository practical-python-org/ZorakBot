...
from zorak.utilities.cog_helpers._embeds import embed_docs  # pylint: disable=E0401
...
class UtilityDocumentation(commands.Cog):
    ...
    async def docs(self, ctx, searchterm):
        ...
        soup = BeautifulSoup(requests.get("https://overapi.com/python", timeout=5).content, "html.parser")
